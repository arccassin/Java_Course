    ...
    void scannerCommand(String input)
    {
        ...
        if (phoneFormat == null)
        {
            ...
            } else
            {
                ...
                if (hashMapKeyPhone.containsKey(phoneFormat))
                {
                    showRec(hashMapKeyPhone.get(phoneFormat));
                } else
                {
                    treeMapKeyName.put(input, phoneFormat);
                    hashMapKeyPhone.put(phoneFormat, input);
                }
            }
        } else
        {
            ...
            } else
            {
                ...
                } else
                {
                    ...
                    hashMapKeyPhone.put(phoneFormat, name);
                }
